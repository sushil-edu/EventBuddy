...
public class AgendaAdapterWithoutTrack extends RecyclerView.Adapter<AgendaAdapterWithoutTrack.ViewHolder> {
    ...
    AgendaAdapterWithoutTrack(Activity activity, List<Detail> detailArrayList, String displayLabel, int trackID) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int i) {
        View view =
                LayoutInflater.from(parent.getContext()).inflate(R.layout.agenda_cell, parent, false);
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, @SuppressLint("RecyclerView") final int position) {
        ...
        //session breaf
        holder.layout_agenda_detail.setOnClickListener(v -> {
...
// be received by the ReceiverActivity.
    ...
    private void dialogRating(final Context context, String title, final int trackID,
        ...
        cancel.setOnClickListener(view -> rate.dismiss());

        ratingBar.setOnRatingBarChangeListener((ratingBar1, v, b) -> {
        });

        Objects.requireNonNull(rate.getWindow()).setLayout(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT);
        rate.show();
