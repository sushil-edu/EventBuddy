...
public class CONSTANTS {
    ...
    public static final String TANDC = "Terms and Conditions";
    public static final String POLLING = "Polling";
    public static final String ASKAQUESTION = "Ask a Question";
    ...
    public static final String RESCHEDULE = "Re-Schedule";
